...
infsize="inf1"#alternative:inf3,inf5
result_type="F1"#alternative choose: TPR,FPR
y_title="F1 value"#alternative choose: TPR,FPR
plot_total1=plot_uni_inter_single2(total_result, "scenario 1",infsize,title="Setting 1",legend_position="right",result_type=result_type,y_title=y_title)
plot_total2=plot_uni_inter_single2(total_result, "scenario 2",infsize,title="Setting 2",result_type=result_type,y_title=y_title)
plot_total3=plot_uni_inter_single2(total_result, "scenario 3",infsize,title="Setting 3",result_type=result_type,y_title=y_title)
plot_total4=plot_uni_inter_single2(total_result, "scenario 4",infsize,title="Setting 4",result_type=result_type,y_title=y_title)
...
ggsave(paste0("simu_",result_type,"_",infsize,".png"), plot = combined_plot, width = 12, height = 12, dpi = 300)
