###############################################################################################################
                                    #venn plot draw for Figure S1-S3
##########################################################################################################
library(ggvenn)
...
load(here::here(dir,"data_scc_svgene_list.RData"))
...
load(here::here(dir,"data_dlpfc_samedonor_svgene_list.RData"))
venn_list=list()
...
ggsave(paste0("combined_venn_scc.png"), plot = combined_plot, width = 12, height =6, dpi = 300)
