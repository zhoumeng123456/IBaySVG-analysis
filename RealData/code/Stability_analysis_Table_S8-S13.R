...
dataset="acrossdonor"
matrix1=as.matrix(read.csv(here(paste0("data/Realdataset/dlpfc ",dataset),paste0("matrix1_count_",dataset,".csv")),row.names = 1,check.names = FALSE))
matrix2=as.matrix(read.csv(here(paste0("data/Realdataset/dlpfc ",dataset),paste0("matrix2_count_",dataset,".csv")),row.names = 1,check.names = FALSE))
matrix3=as.matrix(read.csv(here(paste0("data/Realdataset/dlpfc ",dataset),paste0("matrix3_count_",dataset,".csv")),row.names = 1,check.names = FALSE))
matrix4=as.matrix(read.csv(here(paste0("data/Realdataset/dlpfc ",dataset),paste0("matrix4_count_",dataset,".csv")),row.names = 1,check.names = FALSE))
position1=as.matrix(read.csv(here(paste0("data/Realdataset/dlpfc ",dataset),paste0("matrix1_position_",dataset,".csv")),row.names = 1))
position2=as.matrix(read.csv(here(paste0("data/Realdataset/dlpfc ",dataset),paste0("matrix2_position_",dataset,".csv")),row.names = 1))
position3=as.matrix(read.csv(here(paste0("data/Realdataset/dlpfc ",dataset),paste0("matrix3_position_",dataset,".csv")),row.names = 1))
position4=as.matrix(read.csv(here(paste0("data/Realdataset/dlpfc ",dataset),paste0("matrix4_position_",dataset,".csv")),row.names = 1))
calpha1=as.matrix(read.csv(here(paste0("data/Realdataset/dlpfc ",dataset),paste0("matrix1_celltype_",dataset,".csv")),row.names = 1))
calpha2=as.matrix(read.csv(here(paste0("data/Realdataset/dlpfc ",dataset),paste0("matrix2_celltype_",dataset,".csv")),row.names = 1))
calpha3=as.matrix(read.csv(here(paste0("data/Realdataset/dlpfc ",dataset),paste0("matrix3_celltype_",dataset,".csv")),row.names = 1))
calpha4=as.matrix(read.csv(here(paste0("data/Realdataset/dlpfc ",dataset),paste0("matrix4_celltype_",dataset,".csv")),row.names = 1))
